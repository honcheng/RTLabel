...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	NSString *text = @"<p align=left>Lorem <font kern=35 underline=2 style=italic color=blue>ipsum</font> dolor sit amet, <a href='http://buuuk.com'>buuuk.com</a> <i>consectetur adipisicing elit, sed do eiusmod tempor</i> <u color=red>incididunt ut</u> <uu color=green>labore et dolore</uu> magna aliqua.</p><p align=right><i>Ut enim ad minim</i> veniam, <b>quis nostrud</b> exercitation <font color=#CCFF00 face=HelveticaNeue-CondensedBold size=30>ullamco</font> laboris <b>nisi</b> ut aliquip <font color='blue' size=30 stroke=1>ex ea commodo consequat.</font> Duis <a href='http://google.com'>google.com</a> aute irure dolor in <font face=Cochin-Bold size=40>reprehenderit</font> <font face=AmericanTypewriter size=20 color=purple>in voluptate velit esse cillum dolore</font> eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat <i>non <font color=cyan>proident, <b>sunt in <u>culpa qui</u> officia</b> deserunt</font> mollit</i> anim id est laborum.</p>";
